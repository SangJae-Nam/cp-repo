...
class SegmentTree2_13537 : public SegmentTree2<vector<int>, merge, empty> {
public:
	SegmentTree2_13537(const vector<vector<int>> &v) : SegmentTree2<vector<int>, merge, empty>(v) {}
